  ...
  return (
    <form onSubmit={onSubmitHandler} className='container p-4 flex flex-col w-full items-start gap-3'>
      ...
      <div>
        ...
        <input min={0} className='w-full px-3 py-2 border-2 border-gray-300 rounded sm:w-[200px]' onChange={e => {setSalary(e.target.value)}} type="Number" placeholder='2500'/>
      </div>
