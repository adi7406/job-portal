                    ...
                    {viewApplicationsPageData.map((applicat,index)=>(
                        <tr key={index} className='text-gray-700'>
                            ...
                            <td className='py-2 px-4 border-b text-center flex'>
                                <img className='w-10 h-10 rounded-full mr-3 max:sm-hidden' src={applicat.imgSrc} alt="" />
                                <span>{applicat.name}</span>
                            </td>
                            <td className='py-2 px-4 border-b max-sm:hidden'>{applicat.jobTitle}</td>
                            <td className='py-2 px-4 border-b max-sm:hidden'>{applicat.location}</td>
